...
<html lang="en">
    ...
    <body>  
	<form action="bpForm.php" method="post">
        <div class="header">
            <div class = "row">
                <div class = "col-md-4">
                ...
                <div class = "col-md-4">
                    <p>City Government of Baguio<?php echo $message;?><?php echo $message1;?><?php echo $message2;?><?php echo $message3;?><?php echo $message4;?><?php echo $message5;?></p>
        ...
        <div class="container">
            ...
            <div class = "col-md-9">
                <div class = "scroll">
					...
					<!--   </form>-->
                    <div class = "buttons">
                        <!-- <p><a href="" name="save" value="save" class="btn1">Submit</a></p>	--> 
