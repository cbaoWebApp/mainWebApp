...
$select=$_POST['drop'];
	 if($select == 0){
		 $_SESSION['query'] = "SELECT * FROM sections WHERE controlNum LIKE '%".$valueToSearch."%'";
		 ...
		 $_SESSION['query'] = "SELECT * FROM sections WHERE permitNum LIKE '%".$valueToSearch."%'";
		 $search_result  = filterTable($_SESSION['query']);
	 } else if($select == 2){
		 $_SESSION['query'] = "SELECT * FROM sections WHERE appNum LIKE '%".$valueToSearch."%'";
		  $search_result  = filterTable($_SESSION['query']);
	 } else if($select == 3){
		 $_SESSION['query'] = "SELECT * FROM sections WHERE dateOfApp LIKE '%".$valueToSearch."%'";
		  $search_result  = filterTable($_SESSION['query']);
	 } 
    
}
 else {
    $_SESSION['query'] = "SELECT * FROM sections";
    $search_result = filterTable($_SESSION['query']);
}
...
$(document).ready(function() {
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container-fluid">
            <div class="navbar-header">
              <a class="navbar-brand" href="LineGradeHome.html">Line and Grade Section</a>
            </div>
  ...
  <br>
        ...
        <div class="col-md-6">
		   ...
		   <form action="LineGradeHome.php" method="post">
        ...
        <table  class="table table-radius table-hover">
		  ...
		  if(mysqli_num_rows($search_result) == 0){
			...
			while($row = mysqli_fetch_array($search_result)){
				  ...
				  echo "<td><button id = '$controlNum' class='viewMe' name='viewReq'>Process Application</button>";
                  echo "</tr>";
