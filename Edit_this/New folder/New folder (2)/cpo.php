...
$select=$_POST['drop'];
	 if($select == 0){
		 $_SESSION['query'] = "SELECT * FROM cpo WHERE controlNum LIKE '%".$valueToSearch."%'";
		 ...
		 $_SESSION['query'] = "SELECT * FROM cpo WHERE permitNum LIKE '%".$valueToSearch."%'";
		 $search_result  = filterTable($_SESSION['query']);
	 } else if($select == 2){
		 $_SESSION['query'] = "SELECT * FROM cpo WHERE appNum LIKE '%".$valueToSearch."%'";
		  $search_result  = filterTable($_SESSION['query']);
	 } else if($select == 3){
		 $_SESSION['query'] = "SELECT * FROM cpo WHERE dateOfApp LIKE '%".$valueToSearch."%'";
		  $search_result  = filterTable($_SESSION['query']);
	 } 
    
}
 else {
    $_SESSION['query'] = "SELECT * FROM cpo";
    $search_result = filterTable($_SESSION['query']);
}
...
$(document).ready(function() {
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation">
          <div class="container-fluid">
            <div class="navbar-header">
              <a class="navbar-brand" href="cpo.php">Chief Processing Official</a>
            </div>
  ...
  <br>
        ...
        <div class="col-md-6">
		   ...
		   <form action="cpo.php" method="post">
