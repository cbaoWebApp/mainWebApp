                    ...
                    <div class="collapsible">
                        ...
                        <div id="own" class="contents">
						 <input type="checkbox" id="owner" name="owner" value="owner" onclick="javascript:uncheck(this);" <?php echo ($_SESSION["owner1"] == 'true' ? 'checked' : ''); ?> >Applicant is the registered owner</input>
                            <ul>
                                ...
                                <input type="checkbox" id="surveyPlan"  name="surveyPlan" value="surveyPlan" <?php echo ($_SESSION["surveyPlan1"] == 'true' ? 'checked' : ''); ?> >  Survey plan prepared by a Geodetic Engineer</input>
                            </ul>
                        </div>
						...
						<input type="checkbox" id="notowner" name="notowner" value="notowner" onclick="javascript:uncheck1(this);" <?php echo ($_SESSION["notowner1"] == 'true' ? 'checked' : ''); ?>>Applicant is not the registered owner</input>
                            <ul>
                                  ...
                                  <input type="checkbox" id="conDeedSale"  name="conDeedSale" value="conDeedSale" <?php echo ($_SESSION["conDeedSale1"] == 'true' ? 'checked' : ''); ?>> Certified Photocopy / Original / duplicate copy of Conditional Deed of Sale, or </input><br>
                                  <input type="checkbox" id="constAuth" name="constAuth" value="constAuth" <?php echo ($_SESSION["constAuth1"] == 'true' ? 'checked' : ''); ?>> Original Copy of Authority to construct on the subject property </input><br>
                            </ul>
                        </div>

                          <input type="checkbox" id="taxDec"  name="taxDec" value="taxDec" <?php echo ($_SESSION["taxDec1"] == 'true' ? 'checked' : ''); ?>> Tax declaration from the City Assessor's Office with the Documentary Stamp</input><br>
                          <input type="checkbox" id="realPropTax"  name="realPropTax" value="realPropTax" <?php echo ($_SESSION["realPropTax1"] == 'true' ? 'checked' : ''); ?>> Latest quarter of the real property tax receipt or certificate of non-tax delinquency with <br>
                            Documentary Stamp from City Treasurer's Office</input><br>
                          <input type="checkbox" id="bpForm"  name="bpForm" value="bpForm" <?php echo ($_SESSION["bpForm1"] == 'true' ? 'checked' : ''); ?>> Duly accomplished Building Permit forms</input><br>
                          <input type="checkbox" id="BuilPlan" name="BuilPlan" value="BuilPlan" <?php echo ($_SESSION["BuilPlan1"] == 'true' ? 'checked' : ''); ?>> Building Plans (to be signed by the Applicants/Owner)</input><br>
                          <input type="checkbox" id="StrucDesign"  name="StrucDesign" value="StrucDesign" <?php echo ($_SESSION["StrucDesign1"] == 'true' ? 'checked' : ''); ?>> Structural Design and Analysis for buildings with floor area of 20 sq.m. or more</input><br>
                          <input type="checkbox" id="BuildSpec" name="BuildSpec" value="BuildSpec" <?php echo ($_SESSION["BuildSpec1"] == 'true' ? 'checked' : ''); ?>> Building Specifications</p>
                         <input type="checkbox" id="billMat" name="billMat" value="billMat" <?php echo ($_SESSION["billMat1"] == 'true' ? 'checked' : ''); ?>>Bill of Materials</input><br>
                        ...
                        <input type="checkbox" id="taxReceipt" name="taxReceipt" value="taxReceipt"<?php echo ($_SESSION["taxReceipt1"] == 'true' ? 'checked' : ''); ?> >Photocopy of updated professional tax receipt and Professional Requlations </input><br>
                            ...
                            and plans.</p>
                        <input type="checkbox" id="zoningCert" name="zoningCert" value="zoningCert" <?php echo ($_SESSION["zoningCert1"] == 'true' ? 'checked' : ''); ?>> Zoning Compliance Certificate from City Planning & Development Office</input><br>
                        <input type="checkbox" id="FireCert" name="FireCert" value="FireCert" <?php echo ($_SESSION["FireCert1"] == 'true' ? 'checked' : ''); ?>> Fire Safety Evaluation Clearance from Fire Department</input><br>
                        <input type="checkbox" id="wmsCert" name="wmsCert" value="wmsCert" <?php echo ($_SESSION["wmsCert1"] == 'true' ? 'checked' : ''); ?>> WWMS BP Certificate from CEPMO (septic tank or sewerage)</input><br>
                        <input type="checkbox" id="logbook"  name="logbook" value="logbook" <?php echo ($_SESSION["logbook1"] == 'true' ? 'checked' : ''); ?>> Construction Logbook</input><br>
                        <input type="checkbox" id="tarpaulin" name="tarpaulin" value="tarpaulin" <?php echo ($_SESSION["tarpaulin1"] == 'true' ? 'checked' : ''); ?>> Construction Tarpaulin</input><br>

                        <input type="checkbox" id="clearance" name="clearance" value="clearance" <?php echo ($_SESSION["clearance1"] == 'true' ? 'checked' : ''); ?>>Clearances from other government agencies, pursuant to no. 12 (B) of Section 302 of <br>
                            the IRR of the National Building Code (P.D. 1096), if applicable</input><br>
                        <div class="contents">
                            <ul>
                                <input type="checkbox" id="dpwh" name="dpwh" value="dpwh" <?php echo ($_SESSION["dpwh1"] == 'true' ? 'checked' : ''); ?>> a. DPWH-if property is located alongside national road</input><br>
                                <input type="checkbox" id="aviation" name="aviation" value="aviation" <?php echo ($_SESSION["aviation1"] == 'true' ? 'checked' : ''); ?>> b. Aviation Transportation Office (ATO)-if property is located alongside airport </input><br>
                                <input type="checkbox" id="psg" name="psg" value="psg" <?php echo ($_SESSION["psg1"] == 'true' ? 'checked' : ''); ?>> c. Presidential Security Group (PSG)-if property is located near mansion house</input><br>
                            </ul>
                        </div>

                        <input type="checkbox" id="notarized" name="notarized" value="notarized" <?php echo ($_SESSION["notarized1"] == 'true' ? 'checked' : ''); ?>>Duly notarized authorization to process and receive approved permit or special power <br>
