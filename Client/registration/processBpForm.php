<?php
	...
	function test_input($data) {
	   ...
	   return $data;
		...
		$_SESSION['$tec6'] = test_input($_POST["tec1"])+test_input($_POST["tec2"])+test_input($_POST["tec3"])+test_input($_POST["tec4"])+test_input($_POST["tec5"])+test_input($_POST["tec6"]);
		...
		if( isset($_SESSION['$lnameErr'])||
			...
			header("Location: /Client2/bpForm.php");
		}else{
			...
			header("Location: /Client2/printForm.php");
		}
$conn->close();
	?>
