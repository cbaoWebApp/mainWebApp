...
function proceed(){
	window.location.href = '/CBAO/Client/registration/insertvalues.php';
}
...
//function validate() {
//	return unload('All the information entered in the form can not be edited after submit. Do you really want to submit?');
//}
